...
class _FileViewerScreenState extends State<FileViewerScreen> {
  ...
  Future<void> _runOCR() async {
    ...
    ScaffoldMessenger.of(context)
        .showSnackBar(const SnackBar(content: Text("Scanning text...")));
          ...
          IconButton(
            ...
            onPressed: () async {
              if (_localFilePath != null) {
                await ShareService.shareFile(_localFilePath!,
                    text: "Shared via FamVault");
              } else {
                ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(content: Text("File not ready yet.")));
              }
            },
          )
        ],
