...
class MemberScreen extends StatefulWidget {
  ...
  const MemberScreen({super.key, required this.userId, required this.familyId, required this.isMe});
...
class _MemberScreenState extends State<MemberScreen> {
  ...
  IconData _getIcon(String iconName) {
    switch (iconName) {
      ...
      default: return Icons.folder_shared;
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text(widget.isMe ? "My Profile" : "Member Profile")),
      body: _isLoading 
                ...
                return InkWell(
                  ...
                  child: Card(
                    child: Column(
                      ...
                      children: [
                        Icon(_getIcon(f['icon'] ?? 'folder'), size: 40, color: Colors.blue),
