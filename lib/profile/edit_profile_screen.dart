            ...
            Row(
              children: [
                ...
                DropdownButton<String>(
                  ...
                  items: const [ '+91', '+1', '+44', '+61', '+81' ].map((c) => DropdownMenuItem(value: c, child: Text(c))).toList(),
                  onChanged: (v) => setState(() { if (v != null) _selectedCountryCode = v; }),
                ),
                const SizedBox(width: 8),
                Expanded(
                  child: TextField(
                    controller: _phoneController,
                    decoration: const InputDecoration(labelText: "Phone Number (10 digits)", border: OutlineInputBorder(), hintText: '9876543210'),
                ...
                onPressed: () async {
                  ...
                  if (confirm == true) {
                    ...
                    try {
                      ...
                      try {
                        if (USER_DELETE_ENDPOINT != 'https://example.com/delete-user') {
                          ...
                          if (resp.statusCode == 200) {
                            ...
                            print('[DeleteAccount] server delete failed: ${resp.statusCode} ${resp.body}');
                        ...
                        print('[DeleteAccount] server delete error: $e');
                      ...
                      var deleted = false;
                      try {
                        // Some clients may expose admin delete; try dynamic call
                        await d.deleteUser();
                        deleted = true;
                      } catch (_) {}
